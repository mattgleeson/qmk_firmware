...
[_QWERTY] = KEYMAP( \
  ...
  KC_LCTL, KC_LGUI, KC_LALT, KC_BSPC, LOWER,   KC_ENT,  KC_SPC,  RAISE,   KC_BSPC, KC_RALT, KC_RGUI, KC_RCTL \
),
...
[_LOWER] = KEYMAP( \
  ...
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_RCBR, KC_BSLS, \
 ...
 */
[_ADJUST] =  KEYMAP( \
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_VOLU, \
  _______, RESET  , RGB_TOG, RGB_MOD, RGB_HUD, RGB_HUI, RGB_SAD, RGB_SAI, RGB_VAD, RGB_VAI, _______, KC_VOLD, \
