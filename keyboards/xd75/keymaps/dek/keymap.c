...
[_QWERTY] = {
  ...
  { KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_EQL,  KC_PGDN, KC_MINS, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_RCTL },
  { KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_GRV,  KC_END,  KC_QUOT, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT },
  { _______, KC_LGUI, KC_LALT, _______, FN,      KC_BSPC, KC_TAB,  _______, KC_ENT,  KC_SPC,  FN,      _______, KC_RALT, KC_RGUI, _______ },
},
