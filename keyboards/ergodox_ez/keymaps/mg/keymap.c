...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_LCTRL,       LT(2,KC_A),     LGUI_T(KC_S),   LALT_T(KC_D),   LCTL_T(KC_F),   KC_G,                                                                           KC_H,           RCTL_T(KC_J),   RALT_T(KC_K),   RGUI_T(KC_L),   LT(2,KC_SCOLON),KC_ENTER,
    OSM(MOD_LSFT),  KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           KC_LBRACKET,                                    KC_RBRACKET,    KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       OSM(MOD_LSFT),
    LT(1,KC_GRAVE), KC_QUOTE,       KC_TRANSPARENT, KC_LEFT,        KC_RIGHT,                                                                                                       KC_UP,          KC_DOWN,        KC_LBRACKET,    KC_RBRACKET,    RESET,
                                                                                                    KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,KC_MEDIA_PLAY_PAUSE,KC_MEDIA_NEXT_TRACK,
                                                                                                                    KC_HOME,        KC_PGUP,
                                                                                    KC_TAB,         KC_TRANSPARENT, KC_END,         KC_PGDOWN,      KC_BSPACE,      KC_SPACE
  ),
