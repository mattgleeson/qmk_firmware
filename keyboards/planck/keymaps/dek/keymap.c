...
[_QWERTY] = {
  ...
  {KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MT(MOD_RSFT,KC_MINS)},
  {KC_LCTL, KC_LGUI, KC_LALT, NUMPAD,  LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_SCLN, KC_MINS, KC_BSLS,   KC_RCTL}
},
/* Lower
 * ,-----------------------------------------------------------------------------------.
 * |   ~  |   !  |   @  |   #  |   $  |   %  |   ^  |   &  |   *  |   (  |   )  | Bksp |
...
[_LOWER] = {
  ...
  {KC_TAB,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_LEFT,   KC_DOWN, KC_UP,    KC_RGHT,    KC_GRV,    KC_TRNS},
...
[_RAISE] = {
  ...
  {KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_DOWN, KC_UP,  KC_LBRC, KC_RBRC, KC_TRNS},
  {_______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_TRNS, KC_TRNS, KC_LPRN, KC_RPRN, _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, KC_TRNS, KC_EQL, KC_TRNS, KC_TRNS}
},
[_NUMPAD] = {
