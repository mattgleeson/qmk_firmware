...
#define MG_1_LH_R2 KC_ , KC_EXLM, KC_AT, KC_LCBR, KC_RCBR, KC_PIPE
#define MG_1_RH_R2 KC_UP, KC_7, KC_8, KC_9, KC_ASTR, KC_F12
#define MG_1_LH_R3 KC_, KC_, KC_DLR, KC_LPRN, KC_RPRN, KC_GRAVE
#define MG_1_RH_R3 KC_DOWN, KC_4, KC_5, KC_6, KC_, KC_
#define MG_1_LH_R4 KC_, KC_PERCENT, KC_CIRCUMFLEX, KC_LBRACKET, KC_RBRACKET, KC_TILD
#define MG_1_RH_R4 KC_AMPR, KC_1, KC_2, KC_3, KC_BSLASH, KC_

#define MG_2_LH_R1 KC_, KC_, KC_, KC_, KC_, KC_
#define MG_2_RH_R1 KC_, KC_, KC_, KC_, KC_, KC_
#define MG_2_LH_R2 KC_, KC_, KC_, KC_MS_UP, KC_, KC_
#define MG_2_RH_R2 KC_END, KC_PGDN, KC_PGUP, KC_HOME, KC_, KC_
#define MG_2_LH_R3 KC_, KC_, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_
#define MG_2_RH_R3 KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_, KC_
#define MG_2_LH_R4 KC_, KC_, KC_, KC_, KC_, KC_
#define MG_2_RH_R4 KC_, KC_AUDIO_VOL_DOWN, KC_AUDIO_VOL_UP, KC_MEDIA_PLAY_PAUSE, KC_MEDIA_NEXT_TRACK, KC_
