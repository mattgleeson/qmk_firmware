...
#define MG_HOME_L LCTL_T(KC_ESC), LT(2,KC_A), LGUI_T(KC_S), LALT_T(KC_D), LCTL_T(KC_F), LSFT_T(KC_G)
...
#define MG_1_LH_R2 KC_DEL, KC_EXLM, KC_AT, KC_LCBR, KC_RCBR, KC_PIPE
