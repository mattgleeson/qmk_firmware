...
#define MG_HOMIFY_L(_a,_s,_d,_f,_g) LT(2,_a), LGUI_T(_s), LALT_T(_d), LCTL_T(_f), LSFT_T(_g)
#define MG_HOMIFY_R(_h,_j,_k,_l,_scln) RSFT_T(_h), RCTL_T(_j), RALT_T(_k), RGUI_T(_l), LT(1,_scln)
...
#define MG_ALH_R3 MG_HOMIFY_L(KC_A, KC_S, KC_D, KC_F, KC_G)
#define MG_ALH_R4 KC_Z, KC_X, KC_C, KC_V, KC_B

#define MG_ARH_R2 KC_Y, KC_U, KC_I, KC_O, KC_P
#define MG_ARH_R3 MG_HOMIFY_R(KC_H, KC_J, KC_K, KC_L, KC_SCLN)
...
#define MG_1_ARH_R3 MG_HOMIFY_R(KC_DOWN, KC_4, KC_5, KC_6, _______)
...
#define MG_2_ARH_R3 MG_HOMIFY_R(KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_BRIGHTNESS_DOWN)
